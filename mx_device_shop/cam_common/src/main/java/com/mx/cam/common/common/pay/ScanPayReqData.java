package com.mx.cam.common.common.pay;
...
public class ScanPayReqData {
     ...
     */
    public ScanPayReqData(String appid,String mch_id, String body,String attach,String outTradeNo,int totalFee,String deviceInfo,
    		String spBillCreateIP,String goodsTag, String notifyUrl, String tradeType, String nonce_str){
